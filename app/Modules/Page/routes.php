...
Route::name( 'front.' )->namespace( 'App\Modules\Page\Controllers\Frontend' )->group( function()
{
    ...
    Route::get( '/vin-check-information', 'PageController@getFAQs' )->name( 'page.faq' );
    Route::post( '/check-the-vin', 'PageController@getCheckTheVin' )->name( 'page.check_the_vin' );
    Route::get( '/payment-direct', 'PageController@getStripe' )->name( 'page.getStripe' );
